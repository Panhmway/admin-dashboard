            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="color.php">Colors</a>
                        <a class="collapse-item" href="border.php">Borders</a>
                        <a class="collapse-item" href="animation.php">Animations</a>
